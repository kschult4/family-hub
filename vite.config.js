      ...
      '/api/ha': {
        ...
        configure: (proxy, options) => {
          proxy.on('proxyReq', (proxyReq, req, res) => {
            proxyReq.setHeader('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI1MTM3MWMzMzE5YzY0Y2NhODQxMzViNjQxODM5NDFiNCIsImlhdCI6MTc1NTEzNDkxNSwiZXhwIjoyMDcwNDk0OTE1fQ.VQiKNJ_uJTynpaufMvxATL-RkvBeVp1AXG0-n0EwvrI');
          });
        }
      }
    }
